var MAINAPP = (function (nsp, $, domU, strU) {
    ...
    */
    ...
    var loadJSON = function (path) {
        ...
        initQuiz = function () {
            loadJSON('https://juzzyo-ffm.github.io/tinkery/JSON/questions.json');
        };
    ...
    var setUpNavigation = function () {
        ...
        navigationProto = {
            ...
            hideQuestion: function () {
                var curQuestion = this.questionsArray[cQuestion];
                curQuestion.hideQuestion();
            },
            showQuestion: function () {
                var newQuestion = this.questionsArray[cQuestion];
